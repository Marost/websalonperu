...
mysql_query("UPDATE ".$tabla_suf."_fotos_slide SET titulo='$titulo', fecha='$fecha', hora='$hora', usuario='$usuario', imagen='$imagen', carpeta='$carpeta' WHERE id=". $_REQUEST["id"].";", $conexion);
