...
$rst_notgaleria=mysql_query("SELECT * FROM ".$tabla_suf."_fotos_slide WHERE noticia=$idnoticia", $conexion);
...
if($num_notgaleria>0){
	...
	while($_POST['flash_uploader_'.$cont.'_tmpname']<>""){
		...
		mysql_query("INSERT INTO ".$tabla_suf."_fotos_slide(fecha, hora, usuario, imagen, noticia, carpeta, orden) 
