...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_fotos WHERE id>0 ORDER BY id DESC;", $conexion);
...
$rst_query=mysql_query("SELECT * FROM ".$tabla_suf."_fotos WHERE id>0 ORDER BY id DESC LIMIT $inicio, $registros;", $conexion);
                  ...
                  <table width="100%" align="center" cellpadding="5" cellspacing="0" id="cebreado-php">
                    <thead>
                      <tr class="titulo-campo">
                        <th height="22" align="left"><a href="form-agregar.php">Agregar</a></th>
